...
```{r}
pg_poa<-PcaGrid(t(jt_poa_norm),kmax = 13, scale=TRUE)
plot(pg_poa)
pg_poak<-PcaGrid(t(jt_poa_normtopk),kmax = 13, scale=TRUE)
plot(pg_poak)
pg_poa5<-PcaGrid(t(jt_poa_normtop5),kmax = 13, scale=TRUE)
plot(pg_poa5)
pg_poa1<-PcaGrid(t(jt_poa_normtop1),kmax = 13, scale=TRUE)
plot(pg_poa1)
```
...
###Find the number of up and down regulated genes in each grouping and calculate z-scores
xp_poa_p2<-jt_poa_norm[which(rownames(jt_poa_norm) %in% names(sumout_jt_poa$MAP)[which(sumout_jt_poa$MAP == "pattern2")]),]
smale<-apply(xp_poa_p2[,11:13],1,mean)
other<-apply(xp_poa_p2[,c(1:10)],1,mean)
full<-apply(xp_poa_p2[,1:13],1,mean)
fsd<-apply(xp_poa_p2[,1:13],1,sd)
zsmale<-(smale-full)/fsd
print("p2")
table(zsmale>0)
write.csv(zsmale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/poa_p2.csv")
...
full<-apply(xp_poa_p3[,1:13],1,mean)
fsd<-apply(xp_poa_p3[,1:13],1,sd)
zlmale<-(lmale-full)/fsd
print("p3")
table(zlmale>0)
write.csv(zlmale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/poa_p3.csv")
...
full<-apply(xp_poa_p4[,1:13],1,mean)
fsd<-apply(xp_poa_p4[,1:13],1,sd)
zmale<-(male-full)/fsd
print("p4")
table(zmale>0)
write.csv(zmale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/poa_p4.csv")
...
full<-apply(xp_poa_p5[,1:13],1,mean)
fsd<-apply(xp_poa_p5[,1:13],1,sd)
zsfemale<-(sfemale-full)/fsd
print("p5")
table(zsfemale>0)
write.csv(zsfemale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/poa_p5.csv")
...
full<-apply(xp_poa_p6[,1:13],1,mean)
fsd<-apply(xp_poa_p6[,1:13],1,sd)
zbig<-(big-full)/fsd
print("p6")
table(zbig>0)
write.csv(zbig,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/poa_p6.csv")
...
full<-apply(xp_poa_p8[,1:13],1,mean)
fsd<-apply(xp_poa_p8[,1:13],1,sd)
zlfemale<-(lfemale-full)/fsd
print("p8")
table(zlfemale>0)
write.csv(zlfemale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/poa_p8.csv")
...
```{r}
pg_vd<-PcaGrid(t(jt_vd_norm),kmax = 13, scale=TRUE)
plot(pg_vd)
pg_vdk<-PcaGrid(t(jt_vd_normtopk),kmax = 13, scale=TRUE)
plot(pg_vdk)
pg_vd5<-PcaGrid(t(jt_vd_normtop5),kmax = 13, scale=TRUE)
plot(pg_vd5)
pg_vd1<-PcaGrid(t(jt_vd_normtop1),kmax = 13, scale=TRUE)
plot(pg_poa1)
```

###Model selection Vd
```{r}
JT_Cond<-c("FB","FB","FS","FS","FS","FS","MB","MB","MB","MB","MS","MS","MS")
pat_jtr<-GetPatterns(JT_Cond)
...
###Find the number of up and down regulated genes in each grouping and calculate z-scores
xp_vd_p2<-jt_vd_norm[which(rownames(jt_vd_norm) %in% names(sumout_jt_vd$MAP)[which(sumout_jt_vd$MAP == "pattern2")]),]
smale<-apply(xp_vd_p2[,11:13],1,mean)
other<-apply(xp_vd_p2[,c(1:10)],1,mean)
full<-apply(xp_vd_p2[,1:13],1,mean)
fsd<-apply(xp_vd_p2[,1:13],1,sd)
zsmale<-(smale-full)/fsd
print("p2")
table(zsmale>0)
write.csv(zsmale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/vd_p2.csv")

xp_vd_p3<-jt_vd_norm[which(rownames(jt_vd_norm) %in% names(sumout_jt_vd$MAP)[which(sumout_jt_vd$MAP == "pattern3")]),]
lmale<-apply(xp_vd_p3[,7:10],1,mean)
other<-apply(xp_vd_p3[,c(1:6,11:13)],1,mean)
full<-apply(xp_vd_p3[,1:13],1,mean)
fsd<-apply(xp_vd_p3[,1:13],1,sd)
zlmale<-(lmale-full)/fsd
print("p3")
table(zlmale>0)
write.csv(zlmale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/vd_p3.csv")

xp_vd_p4<-jt_vd_norm[which(rownames(jt_vd_norm) %in% names(sumout_jt_vd$MAP)[which(sumout_jt_vd$MAP == "pattern4")]),]
male<-apply(xp_vd_p4[,7:13],1,mean)
female<-apply(xp_vd_p4[,c(1:6)],1,mean)
full<-apply(xp_vd_p4[,1:13],1,mean)
fsd<-apply(xp_vd_p4[,1:13],1,sd)
zmale<-(male-full)/fsd
print("p4")
table(zmale>0)
write.csv(zmale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/vd_p4.csv")

xp_vd_p5<-jt_vd_norm[which(rownames(jt_vd_norm) %in% names(sumout_jt_vd$MAP)[which(sumout_jt_vd$MAP == "pattern5")]),]
sfemale<-apply(xp_vd_p5[,3:6],1,mean)
other<-apply(xp_vd_p5[,c(1:2,7:13)],1,mean)
full<-apply(xp_vd_p5[,1:13],1,mean)
fsd<-apply(xp_vd_p5[,1:13],1,sd)
zsfemale<-(sfemale-full)/fsd
print("p5")
table(zsfemale>0)
write.csv(zsfemale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/vd_p5.csv")

xp_vd_p6<-jt_vd_norm[which(rownames(jt_vd_norm) %in% names(sumout_jt_vd$MAP)[which(sumout_jt_vd$MAP == "pattern6")]),]
big<-apply(xp_vd_p6[,c(1:2,7:10)],1,mean)
small<-apply(xp_vd_p6[,c(3:6,11:13)],1,mean)
full<-apply(xp_vd_p6[,1:13],1,mean)
fsd<-apply(xp_vd_p6[,1:13],1,sd)
zbig<-(big-full)/fsd
print("p6")
table(zbig>0)
write.csv(zbig,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/vd_p6.csv")
...
other<-apply(xp_vd_p8[,c(3:13)],1,mean)
full<-apply(xp_vd_p8[,1:13],1,mean)
fsd<-apply(xp_vd_p8[,1:13],1,sd)
zlfemale<-(lfemale-full)/fsd
print("p8")
table(zlfemale>0)
write.csv(zlfemale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/vd_p8.csv")
...
appsem2.vd<-psem(glm(hsd17b4~Pr,family="gaussian",data=vd.df2),glm(hsd11b2~hsd17b4+T,family="gaussian",data=vd.df2),glm(srd5a1~hsd17b4+T,family="gaussian",vd.df2),glm(arb~T+hsd11b2+X11KT+srd5a1+hsd17b4,family="gaussian",data=vd.df2),glm(ara~T+hsd11b2+X11KT+srd5a1+hsd17b4,family="gaussian",data=vd.df2),glm(cyp19a1b~T+hsd17b4+Pr,family="gaussian",vd.df2),glm(esr1~E2+cyp19a1b+hsd17b4,family="gaussian",vd.df2),glm(esr2a~cyp19a1b+E2,family="gaussian",vd.df2),glm(esr2b~cyp19a1b+E2+hsd17b4,family="gaussian",vd.df2),glm(App~ara+arb+esr1+esr2a+esr2b+srd5a1+hsd17b4+E2+T+Pr,family="poisson",vd.df2),data=vd.df2)
summary(appsem2.vd)

appsem3.vd<-psem(glm(hsd17b4~Pr,family="gaussian",data=vd.df2),glm(hsd11b2~hsd17b4+T,family="gaussian",data=vd.df2),glm(srd5a1~hsd17b4+T,family="gaussian",vd.df2),glm(arb~T+hsd11b2+X11KT+srd5a1+hsd17b4,family="gaussian",data=vd.df2),glm(ara~T+hsd11b2+X11KT+srd5a1+hsd17b4,family="gaussian",data=vd.df2),glm(cyp19a1b~T+hsd17b4+Pr,family="gaussian",vd.df2),glm(esr1~E2+cyp19a1b+hsd17b4+Pr,family="gaussian",vd.df2),glm(esr2a~cyp19a1b+E2+Pr,family="gaussian",vd.df2),glm(esr2b~cyp19a1b+E2+hsd17b4+Pr,family="gaussian",vd.df2),glm(App~ara+arb+esr1+esr2a+esr2b+srd5a1+hsd17b4+cyp19a1b,family="poisson",vd.df2),data=vd.df2)
summary(appsem3.vd)
...
outsem3.vd<-psem(glm(hsd17b4~Pr,family="gaussian",data=vd.df2),glm(hsd11b2~hsd17b4+T,family="gaussian",data=vd.df2),glm(srd5a1~hsd17b4+T,family="gaussian",vd.df2),glm(arb~T+hsd11b2+X11KT+srd5a1+hsd17b4,family="gaussian",data=vd.df2),glm(ara~T+hsd11b2+X11KT+srd5a1+hsd17b4,family="gaussian",data=vd.df2),glm(cyp19a1b~T+hsd17b4+Pr,family="gaussian",vd.df2),glm(esr1~E2+cyp19a1b+hsd17b4+Pr,family="gaussian",vd.df2),glm(esr2a~cyp19a1b+E2+Pr,family="gaussian",vd.df2),glm(esr2b~cyp19a1b+E2+hsd17b4+Pr,family="gaussian",vd.df2),glm(outs~ara+arb+esr1+esr2a+esr2b+cyp19a1b+hsd17b4,family="gaussian",vd.df2),data=vd.df2)
summary(outsem3.vd)
...
###Find the number of up and down regulated genes in each grouping and calculate z-scores
xp_ot_p2<-jt_ot_norm[which(rownames(jt_ot_norm) %in% names(sumout_jt_ot$MAP)[which(sumout_jt_ot$MAP == "pattern2")]),]
smale<-apply(xp_ot_p2[,12:14],1,mean)
other<-apply(xp_ot_p2[,c(1:11)],1,mean)
full<-apply(xp_ot_p2[,1:14],1,mean)
fsd<-apply(xp_ot_p2[,1:14],1,sd)
zsmale<-(smale-full)/fsd
print("p2")
table(zsmale>0)
write.csv(zsmale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/ot_p2.csv")
...
full<-apply(xp_ot_p3[,1:14],1,mean)
fsd<-apply(xp_ot_p3[,1:14],1,sd)
zlmale<-(lmale-full)/fsd
print("p3")
table(zlmale>0)
write.csv(zlmale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/ot_p3.csv")

xp_ot_p4<-jt_ot_norm[which(rownames(jt_ot_norm) %in% names(sumout_jt_ot$MAP)[which(sumout_jt_ot$MAP == "pattern4")]),]
male<-apply(xp_ot_p4[,8:14],1,mean)
female<-apply(xp_ot_p4[,c(1:7)],1,mean)
full<-apply(xp_ot_p4[,1:14],1,mean)
fsd<-apply(xp_ot_p4[,1:14],1,sd)
zmale<-(male-full)/fsd
print("p4")
table(zmale>0)
write.csv(zmale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/ot_p4.csv")
...
full<-apply(xp_ot_p5[,1:14],1,mean)
fsd<-apply(xp_ot_p5[,1:14],1,sd)
zsfemale<-(sfemale-full)/fsd
print("p5")
table(zsfemale>0)
write.csv(zsfemale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/ot_p5.csv")
...
small<-apply(xp_ot_p6[,c(4:7,12:14)],1,mean)
full<-apply(xp_ot_p6[,1:14],1,mean)
fsd<-apply(xp_ot_p6[,1:14],1,sd)
zbig<-(big-full)/fsd
print("p6")
table(zbig>0)
write.csv(zbig,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/ot_p6.csv")
...
sdother<-apply(xp_ot_p8[,c(4:14)],1,sd)
full<-apply(xp_ot_p8[,1:14],1,mean)
fsd<-apply(xp_ot_p8[,1:14],1,sd)
zlfemale<-(lfemale-full)/fsd
zlfoth<-(lfemale-other)/sdother
print("p8")
table(zlfemale>0)
write.csv(zlfemale,"~/Desktop/JTR_xscript/Relevant Figures/goterm_search/ot_p8.csv")
...
boxplot(asin(Out/1200)~SexSize,ot.df)
boxplot(log(App+1)~SexSize,ot.df)
boxplot(log(Shim+1)~SexSize,ot.df)
boxplot(T~SexSize,ot.df)
boxplot(X11KT~SexSize,ot.df)
boxplot(E2~SexSize,ot.df)
boxplot(Pr~SexSize,ot.df)
...
par(mar=c(2.5,5,.75,1))
boxplot(T~SexSize,ot.df,col=c("#86BBB8","#86BBB8","#F6AE2D","#F6AE2D"),xaxt="n",cex.axis=1.25,cex.lab=1.75, xlab="",ylab="Testosterone (pg/g/hr)")
axis(1,at=c(1:4),labels = c("Male\nLarger","Male\nSmaller","Female\nLarger","Female\nSmaller"),tick=FALSE)
```
